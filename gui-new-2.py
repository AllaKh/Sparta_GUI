...
class App(QtGui.QMainWindow):
    def __init__(self,app=None):
        ...
        self.grid_layout.addWidget(self.linear,0,0)
        #self.calib_tab.setLayout(self.layout) 
        self.grid_layout.addWidget(self.flat,0,1)
        #self.calib_tab.setLayout(self.layout)
        self.grid_layout.addWidget(self.calib,0,2)
        #self.calib_tab.setLayout(self.layout)
        self.grid_layout.addWidget(self.label1,1,0)
        #self.calib_tab.setLayout(self.layout)
        self.grid_layout.addWidget(self.textbox1,1,1)
        #self.calib_tab.setLayout(self.layout)               
        self.grid_layout.addWidget(self.label2,1,2)
        #self.calib_tab.setLayout(self.layout)
        self.grid_layout.addWidget(self.textbox2,1,3)
        #self.calib_tab.setLayout(self.layout) 
        self.grid_layout.addWidget(self.label3,1,4)
        #self.calib_tab.setLayout(self.layout)
        self.grid_layout.addWidget(self.textbox3,1,5)
        #self.calib_tab.setLayout(self.layout) 
        self.grid_layout.addWidget(self.button_set2,1,6)
        #self.calib_tab.setLayout(self.layout)
        ...
        self.grid_layout.addItem(spacer)
