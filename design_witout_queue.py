...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scope_IP.setText(MainWindow.calib_dat.scope_IP)
        ...
        self.naive_connect.setText(str(MainWindow.calib_dat.naive_connect))
        ...
        self.iters.setText(str(MainWindow.lin_dat.iters))
        ...
        self.slice_ignore.setText(str(MainWindow.lin_dat.slice_ignore))
        ...
        self.sub_pulse_times.setText(str(MainWindow.lin_dat.sub_pulse_times))
        ...
        self.target_freq.setText(str(MainWindow.lin_dat.target_freq))
        ...
        self.scope_scale.setText(str(MainWindow.lin_dat.scope_scale))
        ...
        self.scope_delay.setText(str(MainWindow.lin_dat.scope_delay))
        ...
        self.lin_file_name.setText(MainWindow.lin_dat.file_name)
        ...
        self.by_D2S.setText(str(MainWindow.flat_dat.by_D2S))
        ...
        self.V0.setText(str(MainWindow.flat_dat.V0))
        ...
        self.Kd.setText(str(MainWindow.flat_dat.Kd))
        ...
        self.Kp.setText(str(MainWindow.flat_dat.Kp))
        ...
        self.Ki.setText(str(MainWindow.flat_dat.Ki))
        ...
        self.flat_file_name.setText(MainWindow.flat_dat.file_name)
        ...
        self.Vbias.setText(str(MainWindow.chip_dat.Vbias))       
        ...
        self.GM_DAC.setText(str(MainWindow.chip_dat.GM_DAC)) 
        ...
        self.AMP_ATT.setText(str(MainWindow.chip_dat.AMP_ATT)) 
        ...
        self.scope_scale_2.setText("{:.2e}".format(MainWindow.chip_dat.scope_scale)) 
        ...
        self.scope_delay_2.setText(str(MainWindow.chip_dat.scope_delay)) 
        ...
        self.calib_file_name.setText(MainWindow.chip_dat.file_name)
        ...
        self.graphicsView = Linearization(self.tab_2, width=3.5, height=3.5)
        self.graphicsView.move(790,0)            
    ...
    def setInput(self):
        if not self.lineEdit_11.text() or not self.lineEdit_12.text() or not self.lineEdit_3.text():
            print("Please enter all three values")
        else:
            print(self.lineEdit_11.text() + self.lineEdit_12.text() + self.lineEdit_3.text())  
            self.queue.Q_calib_input.put('Print this! %d' %counter)
...
q_empty=1
    ...
    while q_empty:
        ...
        time.sleep(4)
        q_empty=my_ques.Q_calib_output.qsize()==0
        if not q_empty:
            print('q is full')
            try:
                cal_in_dat = my_ques.Q_calib_output.get(False)

            except:
                print("no data in Q_calib_output",my_ques.Q_calib_output.qsize())
                q_empty=1
                pass            
        # q_empty=1
        counter+=1
