...
def SetupFromScope(ScopeAdress,TimeScale,TOffset,Chan1Offset,TrigCh1,Ch1Scale,Chan4Offset,TrigCh4,Ch4Scale):
    Succses=0
...
if __name__ == "__main__":   
    ...
    TrigCh4="2.0" #V
    Chan4Scale="0.05" #V
    Sucess=SetupFromScope(ScopeAdress,TScale,TOffset,Chan1Offset,TrigCh1,Chan1Scale,Chan4Offset,TrigCh4,Chan4Scale)
    np.disp(Sucess)