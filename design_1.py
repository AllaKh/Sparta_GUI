...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView = CumsumError(self.tab_2, width=3.5, height=3.5)
        ...
        self.graphicsView = OneBit(self.tab_2, width=3.5, height=3.5)
        self.graphicsView.move(790,400) 
    ...
    def setInput(self):
        if not self.scope_IP.text() or not \
            ...
            #print(type(self.Mainwin.calib_dat.iters))
