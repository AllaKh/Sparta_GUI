...
#                                                                             #
#   Description:                                                              #
#   Design and functionality on the GUI frontend                              #
#                                                                             #
###############################################################################
...
class Ui_MainWindow(object):
    def __init__(self):
        # Define counter for data updatinng from queue
        self.iter_counter=0
        
        # Set timer for queue checking
    ...
    #Define display names for GUI objects
    ...
    #Collect FFT data and send it to the queue
    ...
    #Collect Calibration data and send it to the queue
    def setInput(self):
    ...
    def collect_calib_data(self):
        ...
        #self.Mainwin.calib_dat.lin_dat.sub_pulse_times = np.array(self.sub_pulse_times.text()).astype(np.float)
        ...
        self.Mainwin.calib_dat.lin_dat.sub_pulse_times = np.fromstring(self.Mainwin.calib_dat.lin_dat.sub_pulse_times[1:-1],sep=',')
        print(self.Mainwin.calib_dat.lin_dat.sub_pulse_times)
        print(type(self.Mainwin.calib_dat.lin_dat.sub_pulse_times))
        
        self.Mainwin.calib_dat.lin_dat.t_start_lin = self.Mainwin.calib_dat.lin_dat.sub_pulse_times[2*np.arange(len(self.Mainwin.calib_dat.lin_dat.sub_pulse_times)/2).astype(int)]
        self.Mainwin.calib_dat.lin_dat.t_stop_lin = self.Mainwin.calib_dat.lin_dat.sub_pulse_times[1+2*np.arange(len(self.Mainwin.calib_dat.lin_dat.sub_pulse_times)/2).astype(int)]

        print("start",self.Mainwin.calib_dat.lin_dat.t_start_lin)
        print("stop",self.Mainwin.calib_dat.lin_dat.t_stop_lin)
