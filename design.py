...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_Cumsum = pg.PlotWidget()
        layout.addWidget(self.graphicsView_Cumsum)
        ...
        self.tab_3.createGridLayout()
        
        windowLayout = QVBoxLayout()
        windowLayout.addWidget(self.tab_3.horizontalGroupBox)
        self.tab_3.setLayout(windowLayout)
