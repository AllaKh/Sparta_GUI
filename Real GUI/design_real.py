        ...
        if not q_empty:
            ...
            try:
                ...
                if hasattr(self.Mainwin.cal_dat_out,'cums_graph') == True:
                    self.graphicsView = CumsumError_Update(self.tab_2, width=3.5, height=3.5)
                    self.graphicsView.move(470,400) 
...
class CumsumError_Update(FigureCanvas):  
    ...
    def __init__(self, parent=None, width=4.5, height=4, dpi=100):
        ...
        FigureCanvas.setSizePolicy(self,
                ...
                QSizePolicy.Expanding)
        FigureCanvas.updateGeometry(self)
        self.timePlot(self.ques.Q_calib_output.cums_graph)   
