...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_noiise.setGeometry(QtCore.QRect(470, 450, 81, 16))
        self.label_noiise.setObjectName("label_noiise")
        self.noiise = QtWidgets.QLineEdit(self.tab)
        self.noiise.setGeometry(QtCore.QRect(440, 470, 141, 31))
        self.noiise.setObjectName("noiise")
        self.noiise.setText(str(self.Mainwin.fft_dat.noise_freqs))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_noiise.setText(_translate("MainWindow", "Noise bin range"))
